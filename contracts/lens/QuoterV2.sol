...
import '@otterswap/core/contracts/libraries/TickBitmap.sol';
...
contract QuoterV2 is IQuoterV2, IOtterSwapSwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IOtterSwapPool) {
        return IOtterSwapPool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }

    /// @inheritdoc IOtterSwapSwapCallback
    function otterswapSwapCallback(
        ...
        IOtterSwapPool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IOtterSwapPool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
