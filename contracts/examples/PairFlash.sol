...
import '@otterswap/core/contracts/interfaces/callback/IOtterSwapFlashCallback.sol';
...
/// @notice An example contract using the OtterSwap flash function
contract PairFlash is IOtterSwapFlashCallback, PeripheryPayments {
    ...
    function otterswapFlashCallback(
        uint256 fee0,
        uint256 fee1,
        bytes calldata data
    ) external override {
    ...
    /// @notice Calls the pools flash function with data needed in `otterswapFlashCallback`
